...
function ManageBlacklistVendor() {
    ...
    const getblacklistedVendorquery = useQuery(
        "getuserlist",
        getblacklistedVendor
    );
    ...
    function category(cat) {
        console.log('PSH cat = ', cat)
        if (cat?._id === 1) {
            return (
                <TableCell style={{ width: 70, color: "#e55350" }}>
                    {cat?.name}
                </TableCell>
            );
        } else if (cat?._id === 2) {
            return (
                <TableCell style={{ width: 70, color: "#ed6c02" }}>
                    {cat?.name}
                </TableCell>
            );
        } else if (cat?._id === 3) {
            return (
                <TableCell style={{ width: 70, color: "#2e7d32" }}>
                    {cat?.name}
                </TableCell>
            );
        } else {
        ...
        <>
            {openEdituserpop && (
                <EditBlacklistedVendor
                    ...
                    listofuser={getblacklistedVendorquery}
                ></EditBlacklistedVendor>
            )}
            {openEditsubpop && (
                <EditSubscription
